...
cp ~/myopenhab-setup-scripts/config.json ./config.json
cp ~/myopenhab-setup-scripts/user.js ./models/user.js
cp ~/myopenhab-setup-scripts/mailer.js ./mailer.js
...
(crontab -l ; echo "* 7,19 * * * certbot -q renew") | sudo crontab
